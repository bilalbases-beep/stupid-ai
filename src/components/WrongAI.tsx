...
const funnyWrongAnswers = [
  ...
  "Today's limit is over. Not everything in this world is FREE. Buy for more interaction.",
  ...
  "Damn it.",
  "I will be back after a short commercial break. you can stay or you can also go for a leak",
